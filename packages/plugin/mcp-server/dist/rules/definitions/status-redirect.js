const VERSION = 1;
export const statusClientErrorRule = {
    id: "R-STATUS-4XX",
    version: VERSION,
    category: "indexing",
    evaluate(ctx) {
...
export const statusServerErrorRule = {
    id: "R-STATUS-5XX",
    version: VERSION,
    category: "indexing",
    evaluate(ctx) {
...
export const redirectChainLongRule = {
    id: "R-REDIRECT-CHAIN-LONG",
    version: VERSION,
    category: "indexing",
    evaluate(ctx) {
        if (ctx.redirectChain.length < 2)
            return null;
        return {
...
//# sourceMappingURL=status-redirect.js.map
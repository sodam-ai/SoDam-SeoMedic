...
export const titleMissingRule = {
    ...
    evaluate(ctx) {
        if (ctx.statusCode !== 200)
            return null;
        if (ctx.rawSignals.title || ctx.renderedSignals.title)
            return null;
        return {
...
export const h1MissingRule = {
    ...
    evaluate(ctx) {
        if (ctx.statusCode !== 200)
            return null;
        if (ctx.renderedSignals.h1Count > 0)
            return null;
        return {
...
export const h1MultipleRule = {
    ...
    evaluate(ctx) {
        if (ctx.statusCode !== 200)
            return null;
        if (ctx.renderedSignals.h1Count <= 1)
            return null;
        return {
 ...
 */
export const imgAltMissingRule = {

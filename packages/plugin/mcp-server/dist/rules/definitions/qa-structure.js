 ...
 */
export const qaStructureMissingRule = {
    id: RULE_ID,
    version: VERSION,
    category: "geo",
    evaluate(ctx) {
        ...
        return {
            ...
            pageUrl: ctx.pageUrl,
            currentValue: null,
            recommendedValue: "Q&A 구조(FAQPage/QAPage JSON-LD) 없음 — 해당되면 추가 권장(추가한다고 AI 답변엔진 노출이 보장되진 않음)",
        };
    },
};
//# sourceMappingURL=qa-structure.js.map
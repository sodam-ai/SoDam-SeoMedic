 ...
 */
export const defaultAccessTokenProvider = async (keyFilePath, scopes) => {
    let token;
    try {
        ...
        throw new GoogleAuthTokenError(`서비스계정 인증 실패(${keyFilePath}): ${err.message}`);
    }
    if (!token) {
...
//# sourceMappingURL=google-auth-token.js.map
 ...
 */
export function planOgFix(filePath, ogTitle, ogUrl) {
    ...
    const candidates = [];
    if (ogTitle)
        candidates.push({ field: "title", value: ogTitle });
    if (ogUrl)
        candidates.push({ field: "url", value: ogUrl });
...
export function writeOgFix(filePath, updatedText) {
    fs.writeFileSync(filePath, updatedText, "utf-8");
}
//# sourceMappingURL=og-fixer.js.map
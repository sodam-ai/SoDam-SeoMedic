import { installSsrfGuardedRouting } from "../render/browser-pool.js";
import { extractSignalsFromPage } from "../render/dom-signals.js";
 ...
 */
export async function renderLocalBridgeAndExtractSignals(browser, targetUrl, expectedOrigin, timeoutMs = DEFAULT_NAV_TIMEOUT_MS) {
    assertLocalBridgeUrl(targetUrl, expectedOrigin);
    const context = await browser.newContext();
    const page = await context.newPage();
    try {
        await installSsrfGuardedRouting(page, { allowedOrigins: new Set([expectedOrigin]) });
...
//# sourceMappingURL=render-local-bridge.js.map
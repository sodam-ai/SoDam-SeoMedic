 ...
 */
export function diffSignals(raw: PageSignals, rendered: PageSignals): SignalDiff[] {
 ...
 */
export function hasRawRenderedIndexingGap(raw: PageSignals, rendered: PageSignals): boolean {
  const indexingCriticalFields: (keyof PageSignals)[] = ["canonical", "title", "metaRobots"];

...
import type { BaselineSnapshot } from "../db/repositories/baseline.js";
import type { RegressionClassification } from "../db/repositories/regression.js";
 ...
 */
export function classifyRegressions(currentFindings: FindingRecord[], baselineSnapshot: BaselineSnapshot): ClassifyResult {
  const revertedKeys: string[] = [];
  const classification: RegressionClassification = {};

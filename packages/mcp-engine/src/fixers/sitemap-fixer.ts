 ...
 */
function findStaticSitemapArray(filePath: string): { project: Project; arrLit: ArrayLiteralExpression } | null {
...
export function planSitemapFix(filePath: string, missingUrls: string[]): SitemapFixPlan {
...
export function writeSitemapFix(filePath: string, updatedText: string): void {

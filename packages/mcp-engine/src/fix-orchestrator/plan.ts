 ...
 */
export async function planLocalFix(db: SeomedicDb, projectRoot: string): Promise<FixPlanResult> {
  ...
  return { auditRunId: auditRun.id, findings, plannedFixes, reportOnlyFindings, truncated: scanResult.truncated };
}

 ...
 */
export const AI_CRAWLER_CATALOG: AiCrawlerCatalogEntry[] = [
...
export function evaluateAiCrawlerAccess(
  robot: MinimalRobotsQuery | null,
  robotsTxtStatus: "found" | "absent",
  rootUrl: string,
): AiCrawlerAccessReport {
  const entries: AiCrawlerAccessEntry[] = AI_CRAWLER_CATALOG.map((entry) => {

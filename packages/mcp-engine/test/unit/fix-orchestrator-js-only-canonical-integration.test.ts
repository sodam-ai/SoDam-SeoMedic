...
describe("fix-orchestrator 통합 — R-CANONICAL-JS-ONLY gated fixer(JS 계산값 보존 검증)", () => {
  ...
  }, 300_000); // makeIsolatedJsOnlyCanonicalProject()의 node_modules 전체 복사가 Windows CI에서 30s를 넘길 수 있음(2026-08-09 실측). 2026-08-18 전체스위트 동시실행 CI에서 120s도 재차 초과 실측 확인 → 300s로 재상향
